        ...
        { 
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //MailAddress from = new MailAddress("pravartur@yandex.ru", "Web Registration");
                    //// кому отправляем
                    ...
                    //// логин и пароль
                    //smtp.Credentials = new System.Net.NetworkCredential("pravartur@yandex.ru", "010203Deadpool");
